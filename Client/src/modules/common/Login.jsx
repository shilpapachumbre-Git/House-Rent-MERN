      ...
      <div className="flex-grow flex justify-center items-center px-4 pt-24 pb-10">
        <div className="bg-gray-900/80 border border-gray-700 backdrop-blur-md shadow-2xl rounded-xl w-full max-w-md p-6 md:p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <input type="password" name="password" value={data.password} onChange={handleChange} placeholder="Password" className="w-full px-4 py-3 bg-gray-800 border border-gray-700 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 outline-none" required />
